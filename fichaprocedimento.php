...
$sqlpac = "SELECT nome, cpf FROM pacientes WHERE id = '$linhasa[1]'";
                    ...
                    <div class="frames">
                        <div class="frame" id="_page_1">
                            ...
                            <div class="input-control text size2" id="divcpf" data-role="input-control">
                                <input type="text" id="cpf" name="cpf" value="<? echo $linhaspac[1];?>" placeholder="CPF do Paciente">
                            </div>
                            <label>Nome</label>
                            ...
                            <td bgcolor="#FDFDFD">
                                ...
                                <div class="input-control select">
                                    <select name="convenio" id="convenio">
                                        <option value="<? echo $linhasconv[1];?>"><? echo utf8_encode($linhasconv[0]);?></option>
                                        <option value="">--------</option>
