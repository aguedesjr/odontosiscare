...
<body class="metro">
    ...
    <div class="grid">
        <div class="row">
            ...
            <div class="span1"></div>
            <div class="span10">
                <form method="POST" onsubmit="return valida(this);" action="editarprofissionalbd.php" name="salvaprofissional" id="salvaprofissional">
                    ...
                    <div class="frames">
                        <div class="frame" id="_page_1">
                            ...
                            <div class="input-control text" id="divnome" data-role="input-control">
                                <input type="text" id="nome" name="nome" value="<?echo utf8_encode($result[0])?>" placeholder="Nome do Profissional">
                            </div>
                            <table><tr>
                            <td bgcolor="#FDFDFD">
                                <label>Tipo</label>
                            ...
                            <td bgcolor="#FDFDFD">
                                ...
                                <div class="input-control text size2" data-role="input-control">
                                    <input type="text" id="crmcro" name="crmcro" value="<?echo $result[1]?>" placeholder="Insc. do Conselho">
